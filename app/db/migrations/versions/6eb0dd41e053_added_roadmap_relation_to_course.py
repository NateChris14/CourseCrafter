"""added roadmap relation to course

Revision ID: 6eb0dd41e053
Revises: ef737b5b7519
Create Date: 2026-02-25 19:24:41.449670
"""
...
revision: str = "6eb0dd41e053"
down_revision: Union[str, None] = "ef737b5b7519"
...
def upgrade() -> None:
    ...
    # Index drops: safe if already removed
    op.drop_index(
    ...
    # Table drops: use raw SQL IF EXISTS for compatibility across Alembic versions
