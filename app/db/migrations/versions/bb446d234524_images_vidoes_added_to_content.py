...
Revision ID: bb446d234524
Revises: c9391ece59ad
Create Date: 2026-02-23 17:41:49.066960
"""
...
revision: str = "bb446d234524"
down_revision: Union[str, None] = "c9391ece59ad"
...
def upgrade() -> None:
    ...
    # Index drops: use Alembic's if_exists support
    op.drop_index("checkpoints_thread_id_idx", table_name="checkpoints", if_exists=True)
    op.drop_index(
        "checkpoint_writes_thread_id_idx", table_name="checkpoint_writes", if_exists=True
    )
    op.drop_index(
        "checkpoint_blobs_thread_id_idx", table_name="checkpoint_blobs", if_exists=True
    )

    # Table drops: use raw SQL for compatibility (DROP TABLE IF EXISTS)
    ...
    op.add_column(
        "course_modules",
        sa.Column("media_suggestions_json", sa.Text(), nullable=True),
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column("course_modules", "media_suggestions_json")
